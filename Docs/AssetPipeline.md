...
- **Basic Attack combo**: 3 montage sections (one clip, sectioned, not 3 separate clips — matches how AnimNotify-driven combos are typically authored in the existing `Variant_Combat` pattern).
