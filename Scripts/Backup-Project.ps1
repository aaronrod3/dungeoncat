# Backup-Project.ps1
# Mirrors the DungeonCat working tree to D:\Dev\Backups\DungeonCat\Live.
# Safety net for whatever isn't committed yet - Gitea/GitHub only capture committed history.
# Run manually anytime, or via the "DungeonCat Nightly Backup" scheduled task.

$SourcePath = "C:\Users\aaron\Documents\Unreal Projects\DungeonCat"
